...
class ReactionController extends Controller {
	...
	public function input( $method = INPUT_POST) {
		...
		if ( count( $_POST) > 0) {
			...
			$this->__model->setPostid( filter_input( $method, 'postid', FILTER_SANITIZE_STRING));
			$this->__model->setLikeDislike( filter_input( $method, 'like_dislike', FILTER_SANITIZE_STRING));
			$this->__model->setComment( filter_input( $method, 'comment', FILTER_SANITIZE_STRING));
