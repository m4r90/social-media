<form id="post_create" method="POST" action="index.php?model=post&action=create" enctype="multipart/form-data">

	<h2 class="text-base font-semibold text-gray-900">Create your new post</h2>

	<div
		class="flex flex-col items-center lg:grid lg:grid-cols-2 justify-center px-2 py-8 mx-auto lg:py-0 editor mx-auto text-gray-800 rounded-lg bg-gray-300 border border-gray-100 p-4 shadow-lg">
		<div>
			<section class="container col-span-full items-center py-32 ">
		...
		<div class="flex flex-col mr-7">
			...
			<div class="col-span-full">
				<h2 class="text-base font-semibold leading-7 text-gray-900">Post
					Status</h2>
				<div class="flex items-center">


					<label class="relative inline-flex items-center cursor-pointer">
						<input id="public" name="public" type="checkbox" value="1" class="sr-only peer">
						<div
							class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600">
						</div>
						<span class="block text-sm font-medium leading-6 text-gray-900">Public (Your post will
					...
					if (file) {
						...
						reader.onload = (e) => {
							imagePreview.innerHTML =
								`<img src="${e.target.result}" class="max-h-46 rounded-lg mx-auto" alt="Image preview" />`;
							imagePreview.classList.remove('border-dashed', 'border-2',
								'border-gray-400');
