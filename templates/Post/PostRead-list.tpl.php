        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-2xl py-10 sm:py-16 lg:max-w-none  ">
                <div class="p-8 pb-40  border bg-gray-200 border-gray-300 rounded">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 ">#<?= $data[$n]['id'] ?> <?= $data[$n]['title']?></h2>
                    ...
                    <div class="mt-6 space-y-12 lg:grid lg:grid-cols-2 lg:gap-x-6 lg:space-y-0">
                        <div class="group relative">
                            ...
                            <ul>
                                <p>Images</p>
                                <?php for ($i = 0; $i < count( $data[$n]["images"]); $i++) { ?>
                                <il>
                                    <?= $data[$n]["images"][$i] ?>
                                </il>
                                <?php } ?>
                        ...
                        <div class="group relative">
                            <div class="flex gap-2">
                                ...
                                <button
                                    ...
                                    <span><?= $data[$n]["reactions"]["countLikes"] ?></span>
                                </button>
                                ...
                                <button
                                    ...
                                    <span><?= $data[$n]["reactions"]["countDislikes"] ?></span>
                                </button>

                            </div>

                            <div class="relative h-80 w-full mt-6  sm:h-64">
                                <p class="text-base font-semibold text-gray-900"> <?= $data[$n]["text"]?> </p>
                                <div>
                                    ...
                                    <div class="flex items-center mt-4 bg-white rounded-lg">
                                        ...
                                        <p class="p-3 text-base text-gray-900 ">
                                            <?= $data[$n]["reactions"]["items"][$r]["comment"] ?> <br>
                                            by <?= $data[$n]["reactions"]["items"][$r]["username"] ?>
                                        </p>
                                    </div>
                                    <?php if ($r >= 2) { ?>
